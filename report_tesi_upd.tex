...
\begin{minipage}[c]{.40\textwidth}
\centering\setlength{\captionmargin}{0pt}%
\includegraphics[width=.90\textwidth]{images/features_original_image.jpeg}
\caption{(a)}
\end{minipage}%
\hspace{10mm}%
\begin{minipage}[c]{.40\textwidth}
\centering\setlength{\captionmargin}{0pt}%
\includegraphics[width=.90\textwidth]{images/features_extracted_features.jpeg}
\caption{(b)}
\end{minipage}
\caption{Original image (a) and extracted features (b), according to 1.30}
\end{figure}
...
\begin{itemize}
	...
	\item{\emph{Step 2}}: associate each transformed line to the closest line in scan $i$, in terms of distance between middlepoints
