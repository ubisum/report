...
\begin{equation}
	\begin{aligned}
		...
		\epsilon_{\theta} &= \epsilon_{abs}-\epsilon_{calc}
	\end{aligned}
\end{equation}
...
If we let the robot travel on both directions $n$ times (usually, $n=5$), at the end of each run robot will accumulare a pose error as explained in (). We can compute the center of gravity of these errors according to the following relations:
\begin{equation}
	\begin{aligned}
